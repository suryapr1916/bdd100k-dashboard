...
IMAGES_DIR = os.path.join(ASSIGNMENT_DATA_ROOT, "bdd100k_images_100k/bdd100k/images/100k")
LABELS_DIR = os.path.join(ASSIGNMENT_DATA_ROOT, "bdd100k_labels_release/bdd100k/labels")
NEW_LABELS_DIR = os.path.join(ASSIGNMENT_DATA_ROOT, "bdd100k_images_100k/bdd100k/labels/100k")
