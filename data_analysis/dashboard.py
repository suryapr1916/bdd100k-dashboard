...
def extract_rgb_and_dimensions(filtered_data, split):
    ...
    for item in sampled_data:
        ...
        img_path = os.path.join(
            f"data/assignment_data_bdd/bdd100k_images_100k/bdd100k/images/100k/{split}",
            img_name,
        )
...
def process_filtered_data(filters):
    ...
    """
    try:
        file_path = f"data/assignment_data_bdd/bdd100k_labels_release/bdd100k/labels/bdd100k_labels_images_{filters['split']}.jsonl"
